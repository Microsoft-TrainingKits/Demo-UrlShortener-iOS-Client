...
In this demonstration, you will walk through connecting an iOS client to a Windows Azure Website hosted backend.
...
If you find any issues with this demo that you can't fix, feel free to report them in the [issues](https://github.com/WindowsAzure-TrainingKit/Demo-UrlShortener-iOS-Client/issues) section of this repository.